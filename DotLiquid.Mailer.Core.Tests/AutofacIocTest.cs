...
using System.Linq;
using Autofac;
using DotLiquid.Mailer.Core.Tests.Blocks;
using DotLiquid.Mailer.Core.Tests.Filters;
using DotLiquid.Mailer.Core.Tests.Model;
using DotLiquid.Mailer.Core.Tests.Tags;
using Microsoft.VisualStudio.TestTools.UnitTesting;

namespace DotLiquid.Mailer.Core.Tests
{
